...
# MODIFICACIÓN: Descargar el checkpoint personalizado v10-nsfw
# Opción 1a: Con wget (si la URL directa está disponible)
RUN wget -q https://huggingface.co/v10/wan2.2-i2v-rapid-aio-v10-nsfw/resolve/main/wan2.2-i2v-rapid-aio-v10-nsfw.safetensors \
    -O /ComfyUI/models/diffusion_models/wan2.2-i2v-rapid-aio-v10-nsfw.safetensors

# Opción 1b: Con huggingface-cli (más confiable)
# RUN huggingface-cli download v10/wan2.2-i2v-rapid-aio-v10-nsfw \
#     wan2.2-i2v-rapid-aio-v10-nsfw.safetensors \
#     --local-dir /ComfyUI/models/diffusion_models \
#     --local-dir-use-symlinks False

# Mantener los modelos auxiliares originales (VAE, CLIP, Text Encoder)
...
# LoRAs opcionales (puedes comentarlas si el checkpoint v10 ya las incluye)
